...
const Carousel = () => {
  return (
    <div>
      ...
      <div className="flex flex-col w-full lg:flex-row mt-6 mb-16">
        ...
        <div className="grid flex-grow h-45 card bg-base-300 rounded-box place-items-center p-8">
          ...
          <span>
            Start a live chat Our customer care specialists are available to
            chat with you live and help you address any problems you have
          </span>
          <button className="btn btn-wide mt-3 bg-secondary font-bold">
            START A LIVE SHAT
          </button>
